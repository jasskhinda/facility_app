...
DO $$
BEGIN
    RAISE NOTICE 'Payment system database setup completed successfully!';
    RAISE NOTICE 'Created tables: facility_payment_methods, facility_invoices, facility_invoice_payments, facility_payment_disputes, payment_verification_audit_log, payment_settings';
    RAISE NOTICE 'Created functions: update_payment_status_with_audit, set_default_payment_method';
    RAISE NOTICE 'Created view: dispatcher_payment_verification_view';
