 ...
 */
async function sendEmail({ to, subject, text, html, fromEmail = null }) {
  try {
    // Determine the From address
    const defaultFrom = process.env.EMAIL_FROM || 'Compassionate Care Transportation <app@compassionatecaretransportation.com>';
 ...
 * @returns {Promise} - Email sending result
 */
async function sendEmailToMany({ to, subject, text, html, fromEmail = null }) {
  try {
