...
export const PRICING_CONFIG = {
  ...
  COMPANY_OFFICE: {
    ...
    ADDRESS: "1234 Compassionate Way, Columbus, OH 43215", // Update with actual address
    LAT: 39.9612,    // Columbus, OH coordinates (update with actual)
    LNG: -82.9988
  },
  HOLIDAYS: [
...
export function calculateTripPrice({
  ...
  isVeteran = false // Veteran status for discount
}) {
  let breakdown = {
    basePrice: 0,
    roundTripPrice: 0,
  ...
  // Apply veteran discount (10% for facility app)
  if (isVeteran) {
    breakdown.veteranDiscount = subtotal * 0.10; // 10% discount for veterans
  } else {
