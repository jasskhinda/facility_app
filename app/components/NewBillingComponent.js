          ...
          <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
            ...
            {(pendingTrips.length > 0 || upcomingTrips.length > 0 || approvedTrips.length > 0 || cancelledTrips.length > 0) ? (
              ...
              <div className="p-8 text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">No other trips this month</h3>
                <p className="mt-2 text-sm text-gray-600 max-w-md mx-auto">
                  All trips for this month have been completed and moved to the DUE TRIPS section above.
                </p>
              </div>
            )}
          </div>
