...
export default function BillingView() {
  ...
  const getStatusColor = (status) => {
    const colors = {
      ...
      UPCOMING: 'bg-[#7CCFD0]/20 dark:bg-[#7CCFD0]/30 text-[#60BFC0] dark:text-[#7CCFD0]',
      ...
      pending: 'bg-[#7CCFD0]/20 dark:bg-[#7CCFD0]/30 text-[#60BFC0] dark:text-[#7CCFD0]',
      paid: 'bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400',
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <Link
                                  ...
                                  className="bg-[#7CCFD0] text-white px-3 py-1 rounded text-sm hover:bg-[#60BFC0] transition-colors flex items-center"
                                >
