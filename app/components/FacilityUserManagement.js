            ...
            <div key={facilityUser.id} className="px-6 py-4 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2">
                  <span className={`px-4 py-1.5 text-sm font-medium rounded-full ${getRoleColor(facilityUser.role)}`}>
                    {getRoleLabel(facilityUser.role)}
                  </span>
                  {facilityUser.is_owner === true && (
                    <span className="px-3 py-1.5 text-sm font-medium rounded-full bg-purple-100 text-purple-800">
                      Owner
                    </span>
                  )}
                </div>
